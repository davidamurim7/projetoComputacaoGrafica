...
Camera* glutGUI::cam = new CameraDistante(0,10,20, 0,0,0, 0,1,0);
float glutGUI::savedCamera[9] = {5,5,20, 0,0,0, 0,1,0};
...
int glutGUI::obliquaX = 90;
int glutGUI::obliquaY = -90;
...
void glutGUI::defaultKey(unsigned char key, int x, int y)
{
    ...
    case 's':
        ...
        cout<< savedCamera[0] << "," << savedCamera[1] << "," << savedCamera[2] << "," <<endl;
        cout<< savedCamera[3] << "," << savedCamera[4] << "," << savedCamera[5] << "," <<endl;
        cout<< savedCamera[6] << "," << savedCamera[7] << "," << savedCamera[8] << "," <<endl;
